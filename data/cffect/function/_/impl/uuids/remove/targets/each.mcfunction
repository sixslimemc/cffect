...
data modify storage cffect_ end.target set from storage cffect:_ s.remove[-1].in.uuids[0].uuid
data modify storage cffect_ end.id set from storage cffect:_ s.remove[-1].in.id
