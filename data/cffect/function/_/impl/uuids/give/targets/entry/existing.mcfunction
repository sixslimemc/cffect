...
$execute store result score *give.is_duplicate _cffect run data modify storage cffect:_ g.give[-1].old_cffect set from storage cffect:_ s.give[-1].current_cffects[{id:'$(id)'}]
