...
data modify storage cffect:api duplicate prepend value {trigger:{start:true, end:true}}
execute store result storage cffect:api duplicate[0].old.duration int 1 run scoreboard players get *y _cffect
data modify storage cffect:api duplicate[0].old.data set from storage cffect:_ s.give[-1].old_cffect.data
data modify storage cffect:api duplicate[0].new.duration set from storage cffect:_ s.give[-1].in.duration
data modify storage cffect:api duplicate[0].new.data set from storage cffect:_ s.give[-1].in.data
data modify storage cffect:api duplicate[0].id set from storage cffect:_ s.give[-1].in.id
...
# set {..trigger}:
data modify storage cffect:_ s.give[-1].trigger.start.enable set from storage cffect:api duplicate[0].trigger.start
data modify storage cffect:_ s.give[-1].trigger.start.data set from storage cffect:api duplicate[0].new.data

data modify storage cffect:_ s.give[-1].trigger.end.enable set from storage cffect:api duplicate[0].trigger.end
data modify storage cffect:_ s.give[-1].trigger.end.data set from storage cffect:api duplicate[0].old.data
...
# new task:
data modify storage cffect:_ s.give[-1].create_delay.in.ticks set from storage cffect:api duplicate[0].new.duration
...
data modify storage cffect:_ s.give[-1].merge_cffect.data set from storage cffect:api duplicate[0].new.data
...
data remove storage cffect:api duplicate[0]