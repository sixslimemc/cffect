#> cffect:_/impl/uuids/give/targets/trigger_start
#--------------------
# 
#--------------------

data modify storage cffect:_ util.execute_trigger.in.data set from storage cffect:_ s.give[-1].trigger.start.data
...
data modify storage cffect:_ util.execute_trigger.in.command set from storage cffect:_ s.give[-1].definition.start
